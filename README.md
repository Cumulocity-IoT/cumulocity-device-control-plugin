...
# Device control and status widget [<img width="35" src="https://user-images.githubusercontent.com/32765455/211497905-561e9197-18b9-43d5-a023-071d3635f4eb.png"/>](https://github.com/Cumulocity-IoT/cumulocity-device-control-plugin/releases/download/1.2.4/sag-ps-pkg-device-control-widget-1.2.4.zip)
...
* This widget support runtime deployment. Download [Runtime Binary](https://github.com/Cumulocity-IoT/cumulocity-device-control-plugin/releases/download/1.2.4/sag-ps-pkg-device-control-widget-1.2.4.zip) and install via Administrations --> Ecosystems --> Applications --> Packages.
...
NOTE: This guide assumes that you have followed the [installation](https://github.com/Cumulocity-IoT/cumulocity-runtime-widget-loader) instructions
